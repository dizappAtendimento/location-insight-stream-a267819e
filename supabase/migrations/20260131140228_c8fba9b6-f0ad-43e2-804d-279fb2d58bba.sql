-- Atualizar create_disparo para suportar modo SEQUÊNCIA
-- No modo sequência, cria um registro para CADA mensagem de CADA contato
...
DECLARE
  ...
  -- NOVO: Modo de mensagem (variation ou sequence)
