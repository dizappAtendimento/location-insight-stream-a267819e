-- Atualizar create_disparo para suportar variações dentro de cada etapa
-- Se uma mensagem tem variações, escolhe uma aleatoriamente (incluindo o texto original)
