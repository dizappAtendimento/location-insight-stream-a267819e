      ...
      <div className="p-6 space-y-6">
        ...
        <div className="opacity-0 animate-fade-in" style={{ animationDelay: '0ms' }}>
          <div className="flex items-center gap-3 mb-2">
            <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-[#0A66C2] shadow-lg shadow-[#0A66C2]/20">
              <Linkedin className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-foreground">LinkedIn Extractor</h1>
              <p className="text-muted-foreground text-sm">Encontre profissionais por segmento</p>
            </div>
          </div>
        </div>
