      ...
      <SidebarFooter className="px-2 py-4 border-t border-slate-800/50">
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuItem 
              onClick={toggleTheme}
              className="text-slate-300 hover:text-white hover:bg-slate-700/50 focus:text-white focus:bg-slate-700/50 data-[highlighted]:bg-slate-700/50 data-[highlighted]:text-white cursor-pointer"
            >
            ...
            <DropdownMenuItem asChild className="text-slate-300 hover:text-white hover:bg-slate-700/50 focus:text-white focus:bg-slate-700/50 data-[highlighted]:bg-slate-700/50 data-[highlighted]:text-white cursor-pointer">
              <Link to="/perfil">
            ...
            <DropdownMenuItem 
              onClick={logout}
              className="text-red-400 hover:text-red-300 hover:bg-slate-700/50 focus:text-red-300 focus:bg-slate-700/50 data-[highlighted]:bg-slate-700/50 data-[highlighted]:text-red-300 cursor-pointer"
            >
